...
//MONGO_URI = "mongodb+srv://jeannille:cs5610f20@movie-app-cluster.eqlwa.mongodb.net/sample_mflix?"
...
// cluster. * See https://docs.mongodb.com/ecosystem/drivers/node/ for more details */ const uri =
// "mongodb+srv://jeannille:cs5610f20@movie-app-cluster.eqlwa.mongodb.net/sample_mflix?retryWrites=true&w=majority"
// const client = new MongoClient(uri);  try { // Connect to the MongoDB cluster await
// client.connect();  // Make the appropriate DB calls await  listDatabases(client);  } catch (e) {
// console.error(e); } finally { await client.close(); } }  main().catch(console.error);
